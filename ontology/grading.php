...
if (check_grades($id) == true) {
    grade_students($_GET["id"]);
    echo 'Поените на студентите се успешно распределени';
} else {
    echo 'Грешка. Поените веќе еднаш се распределени.';
}
?>
...
<script type="text/javascript">
    function f1()
    {
        window.location= <?php echo "\"teacherstudents.php?id=" . $_GET["id"] . "\"" ?>
    }
...
<input type="button" value="Врати се назад" onclick="f1();" />
<?php
echo $OUTPUT->footer();