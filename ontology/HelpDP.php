...
<div id="accordion">
    ...
    <div>
        ...
        <p align="left"><b><font color="#006FFF"> <?php echo get_string('Dproperties', 'ontology'); ?> </font></b><?php echo ' ' . get_string('Dproperties_definition', 'ontology'); ?></p>
        <p align="left"><b><font> <?php echo get_string('Domain', 'ontology'); ?> </font></b><?php echo ' ' . get_string('Domain_definition', 'ontology'); ?></p> 

        <p align="left"><b><font> <?php echo get_string('Range', 'ontology'); ?></font></b><?php echo ' ' . get_string('Range_DP_definition', 'ontology'); ?></p>
        <p align="left"><b><font> <?php echo get_string('Equivalent_Properties', 'ontology'); ?></font></b><?php echo ' ' . get_string('Equivalent_Properties_definition', 'ontology'); ?></p> 
        <p align="left"><b><font><?php echo get_string('Disjoint_Properties', 'ontology'); ?></font></b> <?php echo ' ' . get_string('Disjoint_Properties_definition', 'ontology'); ?></p>
    </div>
    ...
    <div>
        ...
        <p align="left"><?php echo get_string('Characteristic_of_the_property_is', 'ontology'); ?> </p>

        <ul type="square">
            <li> <b><font color="#006FFF"><?php echo get_string('functional_property', 'ontology'); ?></font></b><?php echo ' ' . get_string('functional_property_definition', 'ontology'); ?>
        </ul>
    </div>
    ...
    <div>
        ...
        <p ><?php echo get_string('Cannot_delete_dproperty_with_subproperty', 'ontology'); ?></p>
    </div>
