...
<div id="accordion">
    <h3><a href="#"><?php echo get_string('Classes', 'ontology'); ?></a></h3>
    <div>
        <p align="left"><b><font color="#FF9D00"><?php echo get_string('Class', 'ontology'); ?></font></b><?php echo ' ' . get_string('Class_definition', 'ontology'); ?></p>

        <p align="left"><b><font color="#FF9D00"><?php echo get_string('Superclass', 'ontology'); ?></font></b><?php echo ' ' . get_string('Superclass_definition', 'ontology'); ?></p>
        <p align="left"><b><font ><?php echo get_string('Equivalent_Classes', 'ontology'); ?></font></b><?php echo ' ' . get_string('Equivalent_Classes_definition', 'ontology'); ?></p>
        <p align="left"><?php echo get_string('Disjoint_Classes_definition', 'ontology'); ?></p>

        <p align="left"><b><font color="#FF9D00"> <?php echo get_string('Subclass', 'ontology'); ?></font></b><?php echo ' ' . get_string('Subclass_definition', 'ontology'); ?></p>

    </div>
    <h3><a href="#"><?php echo get_string('Individuals', 'ontology'); ?></a></h3>
    <div>
        <p align="left"><b><font color="#FF0404"> <?php echo get_string('Individual', 'ontology'); ?></font></b><?php echo ' ' . get_string('Individual_definition', 'ontology'); ?></p>
    </div>
    ...
    <div>
        ...
        <p ><?php echo get_string('Cannot_delete_class_with_subclass', 'ontology'); ?></p>
