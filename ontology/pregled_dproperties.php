...
<?php ?>
    ...
    <script type="text/javascript">
        ...
        function ajax()
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=0&red=0&podtip=0",true);
            xmlhttp.send();
        }
        ...
        function b1_poz(podtip)
        {
            ...
            if(podtip==1)
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=1&red=0&podtip=1",true);
            }
            else
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=1&red=0&podtip=0",true);
            }
            xmlhttp.send();
        ...
        function b1_odb()
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=2&red=0&podtip=0",true);
            xmlhttp.send();
        ...
        function b1_neg()
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=3&red=0&podtip=0",true);
            xmlhttp.send();
        ...
        function b_poz(podtip,red)
        {
            ...
            if(podtip==2)
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=4&podtip=2&red="+red,true);
            }
            else
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=4&podtip=0&red="+red,true);
            }
            xmlhttp.send();
        ...
        function b_odb(red)
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=5&podtip=0&red="+red,true);
            xmlhttp.send();
        ...
        function b_neg(red)
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=6&podtip=0&red="+red,true);
            xmlhttp.send();
        ...
        function b2_poz(podtip,red)
        {
            ...
            if(podtip==3)
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=7&podtip=3&red="+red,true);
            }
            else
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=7&podtip=0&red="+red,true);
            }
            xmlhttp.send();
        ...
        function b2_odb(red)
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=8&podtip=0&red="+red,true);
            xmlhttp.send();
        ...
        function b2_neg(red)
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=9&podtip=0&red="+red,true);
            xmlhttp.send();
        ...
        function b3_poz(podtip,red)
        {
            ...
            if(podtip==4)
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=10&podtip=4&red="+red,true);
            }
            else
            {
                xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=10&podtip=0&red="+red,true); 
            }
        ...
        function b3_odb(red)
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=11&podtip=0&red="+red,true);
            xmlhttp.send();
        ...
        function b3_neg(red)
        {
            ...
            xmlhttp.open("GET","pregled_dproperty.php?id="+document.getElementById("dpropertyid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=12&podtip=0&red="+red,true);
            xmlhttp.send();
    
        }

        function nazad(){
            window.location= <?php echo "\"pregled_dproperties.php?id=" . $id . "&userid=" . $u_id . "\"" ?>
        }
...
<?php echo get_string('Choose_dproperty', 'ontology') . ':'; ?>  <br/>
                        ...
                        <?php echo data_property_hierarhy2("dproperties", "dproperty", 0, $id, $u_id, 0); ?> <br/>
                        <input type="hidden" name="dpropertyid" id="dpropertyid" /> <br/>
