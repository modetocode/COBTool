...
$domain2 = $DB->get_records("ontology_property_expression", array("ontology_propertyid" => $id, "type" => "3", "userid" => $u_id, "course_modulesid" => $moduleid));
$equproperties = $DB->get_records("ontology_property_equivalent", array("ontology_propertyid" => $id, "type" => "2", "status" => "2"));
$equproperties2 = $DB->get_records("ontology_property_equivalent", array("ontology_propertyid" => $id, "type" => "2", "userid" => $u_id, "course_modulesid" => $moduleid));
$disproperties = $DB->get_records("ontology_property_disjoint", array("ontology_propertyid" => $id, "type" => "2", "status" => "2"));
$disproperties2 = $DB->get_records("ontology_property_disjoint", array("ontology_propertyid" => $id, "type" => "2", "userid" => $u_id, "course_modulesid" => $moduleid));
?>
