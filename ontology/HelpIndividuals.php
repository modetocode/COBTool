...
<div id="accordion">
    ...
    <div>
        <p align="left"><b><font color="#FF0404"><?php echo get_string('Individual', 'ontology'); ?></font></b><?php echo ' ' . get_string('Individuals_definition', 'ontology'); ?></p>
    </div>
    ...
    <div>
        ...
        <p ><?php echo get_string('individuals_deletion', 'ontology'); ?></p>
    </div>
