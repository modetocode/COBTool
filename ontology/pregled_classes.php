...
<div class="ui-tabs ui-widget ui-widget-content ui-corner-all" id="tabs">
    ...
    <script type="text/javascript">
        ...
        function ajax()
        {
            ...
            xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=0&red=0&podtip=0",true);
            xmlhttp.send();
        }
        ...
        function insertclass()
        {
            ...
            else
            {
                ...
                xmlhttp.open("GET","insertclass.php?id="+document.getElementById("classid").value+"&tip=1&moduleid="+document.getElementById("moduleid").value+"&ime="+document.getElementById("ime").value+"&opis="+document.getElementById("opis").value+"&userid="+document.getElementById("userid").value,true);
                xmlhttp.send();
                ajax1();
            }
        }
        ...
        function b1_poz(podtip)
        {
            ...
            if(podtip==1)
            {
                xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=4&podtip=1&red=0",true);
            }
            else
            {
                xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=4&podtip=0&red=0",true);
            }
            xmlhttp.send();
        ...
        function b1_odb()
        {
            ...
            xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=5&podtip=0&red=0",true);
            xmlhttp.send();
        ...
        function b1_neg()
        {
            ...
            xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=6&podtip=0&red=0",true);
            xmlhttp.send();
        ...
        function b_poz(podtip,red)
        {
            ...
            if(podtip==2)
            {
                xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=1&podtip=2&red="+red,true);
            }
            else
            {
                xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=1&podtip=0&red="+red,true);
            }
            xmlhttp.send();
        ...
        function b_odb(red)
        {
            ...
            xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=2&podtip=0&red="+red,true);
            xmlhttp.send();
        ...
        function b_neg(red)
        {
            ...
            xmlhttp.open("GET","pregled_c2.php?id="+document.getElementById("classid").value+"&moduleid="+document.getElementById("moduleid").value+"&userid="+document.getElementById("userid").value+"&tip=3&podtip=0&red="+red,true);
            xmlhttp.send();
    
        }

        function nazad(){
            window.location= <?php echo "\"pregled_classes.php?id=" . $id . "&userid=" . $u_id . "\"" ?>
        }
    ...
    <form>
        <div id="forma">
            ...
            <table>
                <tr>
                    <td valign="top">
                        <b> <?php echo get_string('Class_data', 'ontology'); ?> </b> <br/>
                        <?php echo get_string('Choose_class', 'ontology') . ':'; ?> <br/>

                        <?php echo class_hierarhy2("superclass", "superklasa", 0, $id, $u_id); ?> <br/>
                        <input type="hidden" name="classid" id="classid"/> <br/>
                        <!--<input type="Button" name="button2" id="button2" value="Додади нова поткласа" style="visibility: hidden;" onclick="prikazFormaDodadiKlasa();"/>-->
